COLORS = {
    ...
    "border": "#2A2A38", # dark gray
}

NAV_ITEMS = [
    ("ti-shopping-cart", "Caja",        "caja"),
    ("ti-package",       "Inventario",  "inventory"),
    ("ti-truck",         "Proveedores", "suppliers"),
    ("ti-users",         "Empleados",   "employees"),
    ("ti-cash",          "Gastos",      "expenses"),
    ("ti-chart-bar",     "Reportes",    "reports"),
]
